 ...
 */
export type ApiType<FunctionMap extends Record<string, (...args: any[]) => any>> = {
  [FunctionName in keyof FunctionMap]: (
    ...args: Parameters<FunctionMap[FunctionName]>
  ) => Promise<ReturnType<FunctionMap[FunctionName]>>;
};
